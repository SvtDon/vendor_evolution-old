...
ALARM_PATH := vendor/evolution/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/evolution/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/evolution/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/evolution/prebuilt/common/media/audio/ui
